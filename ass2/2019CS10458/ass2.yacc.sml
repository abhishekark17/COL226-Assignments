...
\\015\000\005\000\000\000\
\\034\000\005\000\014\000\006\000\013\000\007\000\012\000\008\000\011\000\
\\009\000\010\000\000\000\
\\035\000\005\000\014\000\006\000\013\000\007\000\012\000\008\000\011\000\
\\009\000\010\000\000\000\
\\036\000\000\000\
\\037\000\000\000\
\\038\000\000\000\
...
MlyValue.formula formula1, _, _)) :: ( _, ( _, IF1left, _)) :: rest671
 ...
 in (
"IF IF,"^formula1^"THEN THEN,"^formula2^"THEN THEN,"^formula3^"formula => IF formula THEN formula ELSE formula,"
)
end)
...
formula1) = formula1 ()
 val  formula2 = formula2 ()
 in (formula1^"AND AND,"^formula2^"formula => formula AND formula,")
...
formula1) = formula1 ()
 val  formula2 = formula2 ()
 in (formula1^"XOR XOR,"^formula2^"formula => formula XOR formula,")
